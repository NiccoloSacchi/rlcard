...
ppo_trainer_config = {
    "env": "ParametricScopone",
    "multiagent": {
        "policies_to_train": ["ppo_policy_albi", "ppo_policy_nico"],
        "policies": policies,
        "policy_mapping_fn": lambda agent_id: "ppo_policy_albi" if agent_id in ("player_1", "player_2") else "ppo_policy_nico",
    },
